...
translations = {
    ...
    "el": {  # Greek translations
        ...
        "success_message": "Παρακαλώ χρησιμοποιήστε το πλαϊνό μενού στα αριστερά για να φιλτράρετε τα δεδομένα όπως επιθυμείτε",
...
fig_map = px.choropleth_mapbox(
    ...
    zoom=4.5,  # Further reduced zoom level for a more zoomed-out view
